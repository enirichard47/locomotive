...
export default function EightCollection() {
  ...
  const { data: collection, refetch } = useCollectionBySlug("eight");
  ...
  const collectionPrice = collection?.basePrice ?? 45.99;
  const collectionImage = collection?.image || "/locomotive_logo.jpeg";
  const featuredItems = collection?.featuredItems?.length ? collection.featuredItems : getDefaultFeaturedItems("eight");
  return (
    <div className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center border-b-2 border-[hsl(var(--border))] overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-30">
          <div className="absolute top-20 left-20 w-24 h-24 border-2 border-blue-500 rounded-2xl rotate-12 animate-pulse" />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
              ...
              <span className="text-sm font-bold text-blue-500">MINIMALIST SERIES</span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight">
              <span className="bg-gradient-to-r from-[hsl(var(--foreground))] via-blue-500 to-cyan-500 bg-clip-text text-transparent">
                8 Collection
              </span>
            </h1>
            <p className="text-lg sm:text-xl text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto leading-relaxed">
              Minimalist designs with numeric symbolism and clean aesthetics. Less is more.
            </p>
            <div className="flex items-center justify-center gap-2 text-sm">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[hsl(var(--card))]/50 backdrop-blur-sm border border-[hsl(var(--border))]">
                ...
                <span className="font-medium">Clean Lines</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[hsl(var(--card))]/50 backdrop-blur-sm border border-[hsl(var(--border))]">
