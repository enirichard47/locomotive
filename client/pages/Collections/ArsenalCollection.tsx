...
export default function ArsenalCollection() {
  ...
  const { data: collection, refetch } = useCollectionBySlug("arsenal");
  ...
  const featuredItems = collection?.featuredItems?.length ? collection.featuredItems : getDefaultFeaturedItems("arsenal");
  return (
