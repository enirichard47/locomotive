          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-[hsl(var(--muted-foreground))] mt-2">
                Premium jerseys with statement designs for the competitive spirit
              </p>
            </div>
          </div>
        </div>
              ...
              {[1, 2, 3].map((item) => (
                ...
                >
                  ...
                  <div className="p-4 flex flex-col flex-1">
                    ...
                    <p className="text-[hsl(var(--primary))] font-bold mb-4">$79.99</p>
                    <Link
                      to={`/checkout?item=Arsenal+Jersey+${item}&collection=Arsenal&price=79.99&icon=👕`}
