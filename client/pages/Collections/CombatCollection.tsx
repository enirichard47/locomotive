    ...
    <div className="min-h-screen bg-[hsl(var(--background))]">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center border-b-2 border-[hsl(var(--border))] overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-30">
          <div className="absolute top-20 left-20 w-24 h-24 border-2 border-green-500 rounded-2xl rotate-12 animate-pulse" />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 backdrop-blur-sm">
            ...
            <p className="text-lg sm:text-xl text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto leading-relaxed">
              Bold, aggressive streetwear with military-inspired aesthetics. For those who lead from the front.
            </p>
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[hsl(var(--card))]/50 backdrop-blur-sm border border-[hsl(var(--border))]">
                ...
                <span className="font-medium">Tactical Design</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[hsl(var(--card))]/50 backdrop-blur-sm border border-[hsl(var(--border))]">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
            <div>
              ...
              <p className="text-[hsl(var(--muted-foreground))] leading-relaxed mb-6">
                The Combat Collection represents rebellion and strength. Each piece combines military-inspired design elements with modern streetwear aesthetics. Bold patterns, tactical placements, and powerful graphics define this collection.
              </p>
              <ul className="space-y-3">
                {[
                  "Military-grade fabric quality",
                  "Strategic placement graphics",
