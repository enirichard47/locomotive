...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#EDE8D7] text-[#111827] font-['Quicksand']">
      <Header />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center min-h-[calc(100vh-4rem)] py-20">
            <div className="max-w-xl">
              ...
              <h1 className="font-['Superbubble',cursive,sans-serif] font-extrabold text-6xl sm:text-7xl md:text-[80px] leading-[1.1] mb-6">
                Embody Your Brand.{" "}
      ...
      <section className="py-20 md:py-32 bg-[#EDE8D7] overflow-hidden">
        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-16 md:mb-20">
            <h2 className="font-['Superbubble',cursive,sans-serif] font-bold text-5xl sm:text-6xl md:text-[64px] mb-6">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-b from-[#F4F1E6] to-[#EDE8D7]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square rounded-3xl bg-gradient-to-br from-[#8EDB5A]/5 via-[#EDE8D7] to-[#7C3AED]/5 p-8 shadow-2xl shadow-[#8EDB5A]/20 order-1 md:order-2 overflow-hidden group">
              {/* Animated background gradient */}
              <div className="absolute inset-0 bg-gradient-to-tr from-[#8EDB5A]/10 via-transparent to-[#7C3AED]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              
              {/* Decorative circles */}
              <div className="absolute top-4 right-4 w-20 h-20 bg-[#8EDB5A]/10 rounded-full blur-2xl" />
              <div className="absolute bottom-4 left-4 w-32 h-32 bg-[#7C3AED]/10 rounded-full blur-3xl" />
              
              <div className="relative w-full h-full rounded-2xl bg-gradient-to-br from-[#F4F1E6] to-[#F4F1E6]/50 flex items-center justify-center overflow-hidden border border-white/10 backdrop-blur-sm">
                ...
                <div className="relative w-4/5 h-4/5 group-hover:scale-105 transition-transform duration-500">
                  <Shirt className="absolute inset-0 w-full h-full text-[#6B7280]/5" strokeWidth={0.5} />
                  <div className="relative w-full h-full flex items-center justify-center p-4">
                    <div className="relative w-full h-full">
                      {/* Glow effect behind image */}
                      <div className="absolute inset-0 bg-gradient-to-br from-[#8EDB5A]/20 to-[#7C3AED]/20 blur-2xl opacity-50 group-hover:opacity-75 transition-opacity duration-500" />
                      
                      <img 
                        src="/locomotive_trainpic.jpeg" 
                        alt="Locomotive Train" 
                        className="relative w-full h-full object-cover drop-shadow-2xl rounded-3xl transition-all duration-500 group-hover:drop-shadow-[0_0_30px_rgba(130,255,120,0.3)]" 
                      />
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="relative rounded-[20px] p-10 md:p-16 text-center overflow-hidden bg-[#F4F1E6] shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
            ...
            <div className="relative">
              <h2 className="font-['Superbubble',cursive,sans-serif] font-bold text-5xl md:text-[64px] mb-6">
