...
-- ----------
-- RLS (safe defaults for this app)
-- ----------
...
-- Allow creating tickets without auth
...
-- Allow order creation/read while app has no Supabase auth yet
...
(
  'Manga Collection',
  'Anime-inspired graphics and vibrant colors. Launching soon.',
  '/locomotive_logo.png',
  'manga',
  '/collections/manga',
  true,
